...
### 3.1 点击屏幕到UIButton接收到点击事件过程

- hitest
- positionInView

### HTTPS的连接过程：TLS SSL 预制密钥

### Crash的分类及对应的处理

- 产生原因，都有哪些种类：exception、signal等，
...
##### 4. Core Animation动画与UIView动画的关系
...
### 5.2 NSThread、GCD、NSOperationQueue的区别？
...
##### 2. 线上有做性能检测措施吗？比如卡顿(FPS检查)上报(上报堆栈)

##### 3. 崩溃率有统计过吗？万2左右(Keep)算不错了
